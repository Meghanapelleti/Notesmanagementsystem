...
app.config['MAIL_USERNAME'] = "pelletimeghana2019@gmail.com"  # Sender email
app.config['MAIL_PASSWORD'] = "oxzi qukf hrzh smge"     # App Password from Gmail
...
users = {"pelletimeghana2019@gmail.com": {"password": "06june@2003"}}
...
def send_reset_link():
    ...
    msg = Message("Password Reset Request", 
                  sender="pelletimeghana2019@gmail.com",
                  recipients=[email])
...
def viewall():
    ...
    user_id = session['user_id']
    search_query = request.args.get('q', '')   # <-- NEW LINE
    ...
    return render_template('viewnotes.html', notes=notes, query=search_query)
